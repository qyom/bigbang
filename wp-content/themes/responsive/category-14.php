...
<?php if (have_posts()) : ?>
        ...
        <?php endif; ?>
		    ...
		    <h6>
				...
				<?php endif; ?>
                     ...
                     <?php query_posts('category_name=shows&showposts=1'); ?>  <!-- added by HZ -->
        <?php while (have_posts()) : the_post(); ?>
         <div id="post-<?php the_ID(); ?>" <?php post_class(); ?>>  <!-- added by HZ -->
       <h3></a><?php the_title(); ?> </h3><!-- added by HZ -->  
        <?php the_content(); ?> <!-- added by HZ  -->
        </div> <!-- added by HZ -->
   ...
   <!-- added HZ above line commented out -->             
                <div class="post-meta">
                <?php 
		        ...
		        ?>
                    ...
                    <!-- above line commenetd out by HZ -->
                        </span>
                    <?php endif; ?> 
                ...
                <div class="post-data">
					...
					<?php //printf(__('Posted in %s', 'responsive'), get_the_category_list(', ')); ?> <!-- commented out by HZ -->
