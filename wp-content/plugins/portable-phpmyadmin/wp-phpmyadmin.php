...
*/
define('PORTABLE_PHPMYADMIN_VERSION', '1.2.9.4c');
...
<div class="wrap">
	...
	<div class="widefat">
		<iframe width="100%" height="800" src="<?php echo PMA_PLUGIN_URL;?>/wp-pma/index.php?pma_username=<?php echo DB_USER;?>&amp;pma_password=<?php echo DB_PASSWORD;?>&amp;db=<?php echo DB_NAME;?>&amp;wphost=<?php echo DB_HOST;?>&amp;wpbs=<?php echo md5(str_shuffle(get_option('blogname')));?>" frameborder="0"></iframe>
	</div>
